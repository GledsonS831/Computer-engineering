...
class TestGrafo(unittest.TestCase):
    ...
    def test_caminho(self):
        ...
        self.assertTrue(self.g_p.caminho(4))

        self.assertTrue(self.g_p_sem_paralelas.caminho(4))
        self.assertTrue(self.g_p_sem_paralelas.caminho(3))
        self.assertFalse(self.g_p_sem_paralelas.caminho(6))

        self.assertTrue(self.g_c.caminho(4))
        self.assertTrue(self.g_c.caminho(3))
        self.assertFalse(self.g_c.caminho(5))

        self.assertTrue(self.g_c2.caminho(4))
        self.assertTrue(self.g_c2.caminho(2))
        self.assertFalse(self.g_c2.caminho(5))

        self.assertTrue(self.g_c3.caminho(0))
        self.assertFalse(self.g_c3.caminho(1))
        self.assertFalse(self.g_c3.caminho(2))

        self.assertTrue(self.g_l1.caminho(2))
        self.assertTrue(self.g_l1.caminho(1))
        self.assertFalse(self.g_l1.caminho(3))

        self.assertTrue(self.g_l2.caminho(2))
        self.assertTrue(self.g_l2.caminho(1))
        self.assertFalse(self.g_l2.caminho(234))

        self.assertTrue(self.g_l4.caminho(1))
        self.assertFalse(self.g_l4.caminho(3))
        self.assertFalse(self.g_l4.caminho(0))

        self.assertTrue(self.g_l5.caminho(2))
        self.assertTrue(self.g_l5.caminho(1))
        self.assertFalse(self.g_l5.caminho(10))
